...
function setup() {
  ...
  if (canvasEl && canvasEl.elt) {
    canvasEl.elt.style.touchAction = 'none';
    canvasEl.elt.style.webkitTouchCallout = 'none';
    canvasEl.elt.style.webkitUserSelect = 'none';
    canvasEl.elt.style.userSelect = 'none';
    canvasEl.elt.addEventListener('touchstart', (e) => e.preventDefault(), { passive: false });
    canvasEl.elt.addEventListener('touchmove', (e) => e.preventDefault(), { passive: false });
    canvasEl.elt.addEventListener('contextmenu', (e) => e.preventDefault());
  }
